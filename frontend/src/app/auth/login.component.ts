            ...
            <div class="card login-card shadow-lg">
              <div class="card-body p-5">
                ...
                <div class="mt-4 pt-4" style="border-top: 1px solid rgba(255, 255, 255, 0.1);">
                  <div class="text-center" style="color: rgba(255, 255, 255, 0.6); font-size: 0.85rem;">
                    <p class="mb-2"><strong style="color: var(--color-cream);">Credenciales de prueba:</strong></p>
                    <div style="background-color: rgba(0, 0, 0, 0.2); padding: 0.75rem; border-radius: 0.5rem;">
                      <p class="mb-1"><i class="bi bi-shield-fill-check me-1" style="color: var(--color-success);"></i> <strong>Admin:</strong> admin / admin123</p>
                      <p class="mb-0"><i class="bi bi-person-badge-fill me-1" style="color: var(--color-secondary);"></i> <strong>Vendedor:</strong> seller1 / admin123</p>
                    </div>
                  </div>
                </div>
              </div>
