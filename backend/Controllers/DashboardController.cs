...
public class DashboardController : ControllerBase
{
    ...
    public async Task<ActionResult<DashboardMetricsDto>> GetDashboardMetrics()
    {
        ...
        {
            return StatusCode(500, new { message = "Error al obtener métricas del dashboard", error = ex.Message, stack = ex.StackTrace });
        }
    }
    ...
    public async Task<ActionResult<SalesChartDataDto>> GetSalesChartData()
    {
        ...
        {
            Console.WriteLine($"Error in GetSalesChartData: {ex.Message}");
